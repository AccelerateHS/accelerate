...
convertPreOpenAcc = \case
  ...
  Fold1 f a                       -> Fold1 f (convertAcc a)
  FoldSeg i f e a s               -> FoldSeg i f e (convertAcc a) (convertAcc s)
  Fold1Seg i f a s                -> Fold1Seg i f (convertAcc a) (convertAcc s)
  Scanl f e a                     -> Scanl f e (convertAcc a)
  Scanl' f e a                    -> Scanl' f e (convertAcc a)
  Scanl1 f a                      -> Scanl1 f (convertAcc a)
  Scanr f e a                     -> Scanr f e (convertAcc a)
  Scanr' f e a                    -> Scanr' f e (convertAcc a)
  Scanr1 f a                      -> Scanr1 f (convertAcc a)
