...
travAcc f c l (OpenAcc openAcc) = travAcc' openAcc
  where
    ...
    travAcc' (MapStream fun acc)                   = combine "MapStream" [ travFun f c l fun, travAcc f c l acc ]
    travAcc' (ToStream acc)                        = combine "ToStream" [ travAcc f c l acc ]
    travAcc' (FromStream acc)                      = combine "FromStream" [ travAcc f c l acc ]
    travAcc' (FoldStream fun acc1 acc2)            = combine "MapStream" [ travFun f c l fun, travAcc f c l acc1, travAcc f c l acc2 ]
