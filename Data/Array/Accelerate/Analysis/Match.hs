...
matchPrimFun (PrimCoerce _ s)       (PrimCoerce _ t)       = matchNumType s t
...
matchPrimFun' (PrimCoerce s _)       (PrimCoerce t _)       = matchNumType s t
matchPrimFun' PrimLAnd               PrimLAnd               = Just REFL
matchPrimFun' PrimLOr                PrimLOr                = Just REFL
matchPrimFun' PrimLNot               PrimLNot               = Just REFL
matchPrimFun' PrimOrd                PrimOrd                = Just REFL
...
hashPrimFun (PrimSinh _)                = hash "PrimSinh"
hashPrimFun (PrimCosh _)                = hash "PrimCosh"
hashPrimFun (PrimTanh _)                = hash "PrimTanh"
...
hashPrimFun (PrimToFloating _ _)        = hash "PrimToFloating"
hashPrimFun (PrimCoerce _ _)            = hash "PrimCoerce"
